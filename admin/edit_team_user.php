...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['Edit']))
{
    ...
    if(empty($err_msg))
    {
        ...
        $sql = "UPDATE team SET name=:name,surname=:surname,role=:role,about=:about,img=:img WHERE id=:id";
        $stmt = $conn->prepare($sql);
        $stmt->execute([
         'name'=>$name,
         'surname'=>$surname,
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" name="name" class="form-control" value="<?php echo $last_user['name'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Surname</label>
                                                <input type="text" name="surname" class="form-control" value="<?php echo  $last_user['surname']?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Role</label>
                                                <input type="text" name="role" class="form-control" value="<?php echo $last_user['role']?>">
                                            </div>
                                            <div class="form-group">
                                                <label>About</label>
                                                <textarea id="editor" name="about" class="form-control "><?php echo $last_user['about']?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Image</label>
