...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['add_post']))
{
    ...
    if(empty($err_msg))
    {
        ...
        $sql = "INSERT INTO posts (category_id,title,text,img) VALUES (:category_id,:title,:text,:img)";
        $stmt = $conn->prepare($sql);
        $stmt->execute([
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor" name="textarea" class="form-control "></textarea>
                                            </div>
                                            <div class="card-footer text-right">
                                                <input name="add_post" class="btn btn-primary mr-1" type="submit"
                                                    value="Submit">
                                            </div>
                                        </div>
                                    </form>
